...
@WebServlet("/productListForm.pr")
public class ProductListFormController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductListFormController() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//페지징 처리 구문
		int listCount = new ProductService().productListCount(category); //현재 총게시글 수
		...
		ArrayList<Product> list = new ProductService().productSelectList(category,page);
